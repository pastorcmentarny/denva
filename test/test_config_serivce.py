...
class ConfigServiceTestCases(TestCase):
    ...
    def test_get_radar_hc_url(self):
        ...
        # when
        result = config_service.get_radar_hc_url()
    ...
    def test_get_service_on_off_url(self):
        ...
        # when
        result = config_service.get_service_on_off_url()
    ...
    def test_get_warm_up_measurement_counter(self):
        ...
        # when
        result = config_service.get_warm_up_measurement_counter()
    ...
    def test_get_sensor_log_file_for(self):
        ...
        # when
        result = config_service.get_sensor_log_file_for(2021, 1, 2)
    ...
    def test_get_sensitivity(self):
        ...
        expected_result = 8
        # when
        result = config_service.get_sensitivity()
    ...
    def test_get_disk_space_available_threshold(self):
        ...
        # when
        result = config_service.get_disk_space_available_threshold()
    ...
    def test_get_path_for_cctv_backup(self):
        ...
        # when
        result = config_service.get_path_for_cctv_backup()
    ...
    def test_get_memory_available_threshold(self):
        ...
        # when
        result = config_service.get_memory_available_threshold()
    ...
    def test_get_metrics_service_url(self):
        ...
        # when
        result = config_service.get_metrics_service_url()
    ...
    def test_get_system_hc_reboot_url(self):
        ...
        # when
        result = config_service.get_system_hc_reboot_url()
    ...
    def test_get_path_for_personal_events(self):
        ...
        # when
        result = config_service.get_path_for_personal_events()
    ...
    def test_get_options(self):
        ...
        # when
        result = config_service.get_options()
    ...
    def test_get_current_warnings_url_for(self):
        ...
        # when
        result = config_service.get_current_warnings_url_for('server')
    ...
    def test_get_healthcheck_ip(self):
        ...
        # when
        result = config_service.get_healthcheck_ip()
    ...
    def test_get_log_path_for(self):
        ...
        # when
        result = config_service.get_log_path_for('dev_app')
    ...
    def test_get_system_hc_url(self):
        ...
        # when
        result = config_service.get_system_hc_url()
