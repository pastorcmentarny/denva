...
class Test(TestCase):
    ...
    def test___get_scale_result_from_should_return_hazard(self):
        # given
        scale_params_list = [(500, 'At Aberystwyth, pollution level is Hazardous! (500).Stay at home!'), (250, 'At Aberystwyth, pollution level is Unhealthy (250).Should stay at home.'), (125, 'At Aberystwyth, pollution level is Moderate (125).Limit prolong outdoor activity.'), (50,'At Aberystwyth, pollution level is Good (50).')]
