...
def get_data_row(row):
    data_row = {
        ...
        'colour': row[5],
        'aqi': row[6],
        'uva_index': '{:0.4f}'.format(row[7]),
        'uvb_index': '{:0.4f}'.format(row[8]),
        'motion': row[9],
        'ax': '{:0.4f}'.format(row[10]),
        'ay': '{:0.4f}'.format(row[11]),
        'az': '{:0.4f}'.format(row[12]),
        'gx': '{:0.4f}'.format(row[13]),
        'gy': '{:0.4f}'.format(row[14]),
        'gz': '{:0.4f}'.format(row[15]),
        'mx': '{:0.4f}'.format(row[16]),
        'my': '{:0.4f}'.format(row[17]),
        'mz': '{:0.4f}'.format(row[18]),
